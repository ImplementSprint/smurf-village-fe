...
exports.PayrollModule = PayrollModule = __decorate([
    (0, common_1.Module)({
        imports: [supabase_1.SupabaseModule, auth_module_1.AuthModule, cnb_module_1.CnbModule, timekeeping_module_1.TimekeepingModule],
        controllers: [payroll_controller_1.PayrollController],
        providers: [payroll_service_1.PayrollService, cnb_encryption_service_1.CnbEncryptionService],
