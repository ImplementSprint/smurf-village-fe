...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new applicant notification (internal use)' }),
...
__decorate([
    (0, common_1.Get)('applicant/:applicant_id/unread'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get unread notifications for an applicant' }),
    __param(0, (0, common_1.Param)('applicant_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], NotificationsController.prototype, "getUnreadNotifications", null);
__decorate([
    (0, common_1.Get)('applicant/:applicant_id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get all notifications for an applicant' }),
    __param(0, (0, common_1.Param)('applicant_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Patch)('applicant/:applicant_id/mark-all-read'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Mark all notifications as read for an applicant' }),
    __param(0, (0, common_1.Param)('applicant_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Patch)(':notification_id/mark-read'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Mark a single applicant notification as read' }),
