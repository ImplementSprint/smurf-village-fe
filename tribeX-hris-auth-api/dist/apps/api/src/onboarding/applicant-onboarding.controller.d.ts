...
export declare class ApplicantOnboardingController {
    ...
    submitForReview(sessionId: string): Promise<{
        message: string;
        session_id: string;
        status: string;
    }>;
    ...
    acceptOffer(sessionId: string, req: any): Promise<{
        message: string;
    }>;
    declineOffer(sessionId: string, req: any): Promise<{
        message: string;
    }>;
}
