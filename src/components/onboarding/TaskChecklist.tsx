          ...
          {selectedTask && (
            <div className="space-y-4 overflow-y-auto flex-1 pr-1">
              ...
              {selectedTask.type === "acknowledge" && (() => {
                const contentUrl = getContentUrl(selectedTask);
                return (
                  <div className="space-y-4">
                    {contentUrl && (
                      <div className="w-full bg-slate-100 rounded-lg overflow-hidden h-40">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img src={contentUrl} alt="Document preview" className="w-full h-full object-cover" />
                      </div>
                    )}
              ...
              {selectedTask.type === "confirm" && (() => {
                ...
                return (
                  ...
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={contentUrl} alt="Video thumbnail" className="w-full h-full object-cover" />
