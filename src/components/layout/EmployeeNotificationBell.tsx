...
import {
  Bell, X, Check, Loader2, CheckCircle2, XCircle, ClipboardList, ChevronRight, FilePen,
} from "lucide-react";
import {
  getMyNotifications,
      ...
      {open && (
        ...
        >
          ...
          <div className="px-4 py-3">
            <button
              onClick={() => { setOpen(false); router.push("/employee/onboarding"); }}
