        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <section id="contact-address" className="bg-card border rounded-xl shadow-sm p-6 space-y-5 scroll-mt-6">
            ...
            <FieldRow label="Complete Address" permType="self">
              <Textarea value={contactDraft.complete_address} onChange={(e) => setContactDraft({ ...contactDraft, complete_address: e.target.value })} disabled={!contactEditing} placeholder="Street, Barangay, City, Province, ZIP" className="min-h-20 resize-none disabled:bg-muted/40 disabled:text-muted-foreground" />
            </FieldRow>
          </section>
