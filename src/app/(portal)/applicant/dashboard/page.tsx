    ...
    <div className="space-y-6 max-w-5xl mx-auto animate-in fade-in duration-500">
      <Card className="border-border shadow-sm overflow-hidden bg-card">
        <CardHeader className="bg-muted/20 border-b border-border pb-6">
          <p className="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">Candidate Dashboard</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-5">
        <Card className="xl:col-span-3 border-border shadow-sm bg-card">
        ...
        <Card className="xl:col-span-2 border-border shadow-sm bg-card">
          <CardHeader className="pb-4">
  ...
  return (
    <div className="rounded-xl border border-border bg-muted/20 p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="h-7 w-7 rounded-md bg-primary/10 border border-primary/20 text-primary flex items-center justify-center">
          {icon}
        </span>
      </div>
